...
//                 <div className="mb-4">
//                   <label className="block text-sm mb-1 font-normal">Select Role</label>
//                   <select value={role} onChange={(e) => setRole(e.target.value)} className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-slate-200">
//                     <option value="User">User</option>
//                     <option value="Coach">Coach</option>
